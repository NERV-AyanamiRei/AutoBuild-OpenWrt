...
Build OpenWrt firware [Lean's OpenWrt](https://github.com/coolsnowwolf/lede) or [ImmortalWrt](https://github.com/immortalwrt/immortalwrt) for Redmi_AX6S using GitHub Actions  
